...
namespace LMKit.Integrations.ExtensionsAI.Embeddings
{
    ...
    /// to generate embeddings from text data for use with Microsoft.Extensions.AI consumers.
    /// </summary>
    public sealed class LMKitEmbeddingGenerator : IEmbeddingGenerator<string, Embedding<float>>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LMKitEmbeddingGenerator"/> class using the specified LMKit model.
        ...
        public LMKitEmbeddingGenerator(LM model)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LMKitEmbeddingGenerator"/> class with the provided embedder.
        /// </summary>
        /// <param name="embedder">An instance of <see cref="Embedder"/> used to generate text embeddings.</param>
        public LMKitEmbeddingGenerator(Embedder embedder)
        {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var results = await _embedder.GetEmbeddingsAsync(inputList, cancellationToken).ConfigureAwait(false);
